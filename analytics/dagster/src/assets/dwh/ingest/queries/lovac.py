...
lovac_tables_sql = {
    ...
    "raw_lovac_2019": f"CREATE OR REPLACE TABLE {SCHEMA}.raw_lovac_2019 AS (SELECT * FROM read_csv('s3://{Config.CELLAR_DATA_LAKE_BUCKET_NAME}/lake/lovac/2019/raw.csv', auto_detect = TRUE, ignore_errors = false));",
