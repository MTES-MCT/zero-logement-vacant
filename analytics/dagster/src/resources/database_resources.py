...
@resource(config_schema={
    ...
    "db_user": Field(String, default_value=Config.POSTGRES_PRODUCTION_READONLY_USER),
    "db_password": Field(String, default_value=Config.POSTGRES_PRODUCTION_READONLY_PASSWORD),
