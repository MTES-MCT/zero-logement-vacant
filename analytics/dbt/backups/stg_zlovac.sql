...
cleaned_data AS (
 SELECT
        ...
        TRY_CAST(REGEXP_REPLACE(CAST(ff_y_4326 AS VARCHAR), ',', '.') AS DOUBLE) AS latitude,
        TRY_CAST(REGEXP_REPLACE(CAST(ff_x_4326 AS VARCHAR), ',', '.') AS DOUBLE) AS longitude,
        ff_dcapec2 AS cadastral_classification,
        NULLIF(TRIM(UPPER(nature)), '') AS housing_kind,
        ff_npiece_p2 AS rooms_count,
        (COALESCE(NULLIF(TRIM(CAST(ff_dcapec2 AS VARCHAR)), '')::NUMERIC, 0) > 6)
        OR
        (COALESCE(NULLIF(TRIM(CAST(ff_dnbwc AS VARCHAR)), '')::NUMERIC, 0) = 0)
        OR
        (
            COALESCE(NULLIF(TRIM(CAST(ff_dnbbai AS VARCHAR)), '')::NUMERIC, 0) +
            COALESCE(NULLIF(TRIM(CAST(ff_dnbdou AS VARCHAR)), '')::NUMERIC, 0) = 0
        ) AS uncomfortable,
        CASE
            WHEN TRY_CAST(ff_jannath AS NUMERIC) > 100 THEN COALESCE(TRY_CAST(ff_jannath AS NUMERIC), 0)
            ELSE 0 -- Adding an ELSE clause to handle all other cases, ensuring a default value is always provided
        END AS building_year,
        FLOOR(TRY_CAST(REGEXP_REPLACE(CAST(ff_stoth as VARCHAR), ',', '.') AS NUMERIC)) AS living_area,
        ...
        CONCAT_WS(nullif(trim(ff_dlign3_1), ''), nullif(trim(ff_dlign4_1), ''), nullif(trim(ff_dlign5_1), ''), nullif(trim(ff_dlign6_1), '')) as ff_owner_1_raw_address,
        CONCAT_WS(nullif(trim(ff_dlign3_2), ''), nullif(trim(ff_dlign4_2), ''), nullif(trim(ff_dlign5_2), ''), nullif(trim(ff_dlign6_2), '')) as ff_owner_2_raw_address,
        CONCAT_WS(nullif(trim(ff_dlign3_3), ''), nullif(trim(ff_dlign4_3), ''), nullif(trim(ff_dlign5_3), ''), nullif(trim(ff_dlign6_3), '')) as ff_owner_3_raw_address,
        CONCAT_WS(nullif(trim(ff_dlign3_4), ''), nullif(trim(ff_dlign4_4), ''), nullif(trim(ff_dlign5_4), ''), nullif(trim(ff_dlign6_4), '')) as ff_owner_4_raw_address,
        CONCAT_WS(nullif(trim(ff_dlign3_5), ''), nullif(trim(ff_dlign4_5), ''), nullif(trim(ff_dlign5_5), ''), nullif(trim(ff_dlign6_5), '')) as ff_owner_5_raw_address,
        CONCAT_WS(nullif(trim(ff_dlign3_6), ''), nullif(trim(ff_dlign4_6), ''), nullif(trim(ff_dlign5_6), ''), nullif(trim(ff_dlign6_6), '')) as ff_owner_6_raw_address,
		CONCAT_WS(NULLIF(TRIM(adresse1), ''), NULLIF(TRIM(adresse2), '')) AS owner_partial_address,
        CONCAT_WS(nullif(trim(ff_dlign3_1), ''), nullif(trim(ff_dlign4_1), '')) as ff_owner_1_partial_address,
        CONCAT_WS(nullif(trim(ff_dlign3_2), ''), nullif(trim(ff_dlign4_2), '')) as ff_owner_2_partial_address,
		CONCAT_WS(nullif(trim(ff_dlign3_3), ''), nullif(trim(ff_dlign4_3), '')) as ff_owner_3_partial_address,
        CONCAT_WS(nullif(trim(ff_dlign3_4), ''), nullif(trim(ff_dlign4_4), '')) as ff_owner_4_partial_address,
        CONCAT_WS(nullif(trim(ff_dlign3_5), ''), nullif(trim(ff_dlign4_5), '')) as ff_owner_5_partial_address,
        CONCAT_WS(nullif(trim(ff_dlign3_6), ''), nullif(trim(ff_dlign4_6), '')) as ff_owner_6_partial_address,
		...
		ff_dlign3_1 as ff_owner_1_adresse_1, ff_dlign4_1 as ff_owner_1_adresse_2, ff_dlign5_1 as ff_owner_1_adresse_3, ff_dlign6_1 as ff_owner_1_adresse_4,
		ff_dlign3_2 as ff_owner_2_adresse_1, ff_dlign4_2 as ff_owner_2_adresse_2, ff_dlign5_2 as ff_owner_2_adresse_3, ff_dlign6_2 as ff_owner_2_adresse_4,
		ff_dlign3_3 as ff_owner_3_adresse_1, ff_dlign4_3 as ff_owner_3_adresse_2, ff_dlign5_3 as ff_owner_3_adresse_3, ff_dlign6_3 as ff_owner_3_adresse_4,
		ff_dlign3_4 as ff_owner_4_adresse_1, ff_dlign4_4 as ff_owner_4_adresse_2, ff_dlign5_4 as ff_owner_4_adresse_3, ff_dlign6_4 as ff_owner_4_adresse_4,
		ff_dlign3_5 as ff_owner_5_adresse_1, ff_dlign4_5 as ff_owner_5_adresse_2, ff_dlign5_5 as ff_owner_5_adresse_3, ff_dlign6_5 as ff_owner_5_adresse_4,
		ff_dlign3_6 as ff_owner_6_adresse_1, ff_dlign4_6 as ff_owner_6_adresse_2, ff_dlign5_6 as ff_owner_6_adresse_3, ff_dlign6_6 as ff_owner_6_adresse_4,
