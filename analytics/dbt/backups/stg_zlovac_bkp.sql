...
CASE
WHEN TRY_CAST (ff_jannath AS NUMBER) > 100 THEN COALESCE (TRY_CAST (ff_jannath AS NUMBER),
0)
...
ARRAY_REMOVE (ARRAY_CONSTRUCT (NULLIF (TRIM (adresse1),
''),
...
'')),
NULL) AS owner_raw_address,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_2),
''),
...
'')),
null) as owner_raw_address2,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_3),
''),
...
'')),
null) as owner_raw_address3,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_4),
''),
...
'')),
null) as owner_raw_address4,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_5),
''),
...
'')),
null) as owner_raw_address5,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_6),
''),
...
null) as ff_owner_1_raw_address1,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_3),
''),
nullif (trim (ff_dlign4_3),
''),
),
null) as ff_owner_2_raw_address2,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_4),
''),
nullif (trim (ff_dlign4_4),
''),
),
null) as ff_owner_3_raw_address3,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_5),
''),
nullif (trim (ff_dlign4_5),
''),
),
null) as ff_owner_4_raw_address4,
ARRAY_REMOVE (ARRAY_CONSTRUCT (nullif (trim (ff_dlign3_6),
''),
nullif (trim (ff_dlign4_6),
''),
),
null) as ff_owner_5_raw_address5,
adresse1 as owner_adresse1,
adresse2 as owner_adresse2,
adresse3 as owner_adresse3,
adresse4 as owner_adresse4,
ff_dlign3_2 as ff_owner_1_adresse_1,
ff_dlign4_2 as ff_owner_1_adresse_2,
ff_dlign5_2 as ff_owner_1_adresse_3,
ff_dlign6_2 as ff_owner_1_adresse_4,
ff_dlign3_3 as ff_owner_2_adresse_1,
ff_dlign4_3 as ff_owner_2_adresse_2,
ff_dlign5_3 as ff_owner_2_adresse_3,
ff_dlign6_3 as ff_owner_2_adresse_4,
ff_dlign3_4 as ff_owner_3_adresse_1,
ff_dlign4_4 as ff_owner_3_adresse_2,
ff_dlign5_4 as ff_owner_3_adresse_3,
ff_dlign6_4 as ff_owner_3_adresse_4,
ff_dlign3_5 as ff_owner_4_adresse_1,
ff_dlign4_5 as ff_owner_4_adresse_2,
ff_dlign5_5 as ff_owner_4_adresse_3,
ff_dlign6_5 as ff_owner_4_adresse_4,
ff_dlign3_6 as ff_owner_5_adresse_1,
ff_dlign4_6 as ff_owner_5_adresse_2,
ff_dlign5_6 as ff_owner_5_adresse_3,
ff_dlign6_6 as ff_owner_5_adresse_4,
