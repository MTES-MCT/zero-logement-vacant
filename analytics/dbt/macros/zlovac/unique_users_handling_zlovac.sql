{% macro unique_users_handling_zlovac(index) %}
    SELECT
        ...
        ff_owner_{{ index }}_birth_place AS owner_birth_place,
        ff_owner_{{ index }}_idprodroit AS owner_idprodroit,
        ff_owner_{{ index }}_kind_detail AS owner_kind_detail,
        ff_owner_{{ index }}_property_rights AS owner_property_rights,
        ...
        ff_owner_{{ index }}_entity AS owner_entity,
        ff_owner_{{ index }}_username AS owner_username,
        administrator,
    FROM {{ ref ('int_zlovac') }}
