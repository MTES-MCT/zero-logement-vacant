WITH vacancies_2024 AS (
    SELECT
        ...
        COUNT(CASE WHEN data_year = 2024 AND vacancy_start_year < 2022 THEN 1 END) AS vac_2024_plus_2ans,
        COUNT(CASE WHEN data_year = 2024 AND vacancy_start_year >= 2022 THEN 1 END) AS vac_2024_moins_2ans,
...
vacancies_2020 AS (
    SELECT
        geo_code,
        COUNT(CASE WHEN data_year = 2020 AND vacancy_start_year = 2019 THEN 1 END) AS vac_2020_1an,
        COUNT(CASE WHEN data_year = 2020 AND vacancy_start_year = 2018 THEN 1 END) AS vac_2020_2ans,
        COUNT(CASE WHEN data_year = 2020 AND vacancy_start_year = 2017 THEN 1 END) AS vac_2020_3ans,
        COUNT(CASE WHEN data_year = 2020 AND vacancy_start_year <= 2016 THEN 1 END) AS vac_2020_4ans_plus,
        COUNT(CASE WHEN data_year = 2020 AND vacancy_start_year = 2020 THEN 1 END) AS vac_2020_moins_1an,
