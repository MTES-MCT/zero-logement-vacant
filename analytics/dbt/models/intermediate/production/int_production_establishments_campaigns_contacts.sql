WITH establishment_campaign_contacts AS (
    SELECT
        ...
        COUNT(*) contacted_housing,
        COUNT(DISTINCT pch.housing_id) contacts_number,
    ...
    SELECT
        ...
        COUNT(DISTINCT e.housing_id) contacted_housing_followup_ended,
        COUNT(DISTINCT CASE WHEN new_sub_status = 'N''était pas vacant' THEN e.housing_id END) contacted_housing_followup_ended_not_vacant,
...
SELECT establishment_id,
    {{ pivot_columns_by_year(
        ["contacted_housing", "contacts_number", "contacted_housing_followup_ended", "contacted_housing_followup_ended_not_vacant"],
