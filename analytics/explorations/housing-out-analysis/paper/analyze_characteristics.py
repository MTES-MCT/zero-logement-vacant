...
def analyze_all_stratified(
    ...
    """Analyze all characteristics features stratified by another variable.

    Skips features that match the stratification variable to avoid tautology.
    Note: characteristics table has is_housing_out directly (no join_table needed),
    but the stratification variable may live in another table.
    """
