    ...
    BEGIN
        ...
        IF owner_var.local_id IS NOT NULL THEN
            ...
            IF owner_housing_var.owner_id IS NULL THEN
                ...
                insert into owners_housing(housing_id, owner_id, rank) values ((select id from housing where local_id = owner_var.local_id), owner_var_ids[1], rank);
...
AS $$
    ...
    DECLARE
        ...
        from _extract_zlv_2022_owners_1
