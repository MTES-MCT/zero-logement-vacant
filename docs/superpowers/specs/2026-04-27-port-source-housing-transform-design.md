...
Additional unit tests: 5. **`_apply_changes`** — isolated tests for the three branches 6. **Column mapping** — verify all renames and defaults are correct 7. **`data_file_years`** — deduplication and sorting
