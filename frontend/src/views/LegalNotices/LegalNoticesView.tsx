...
function LegalNoticesView() {
  return (
    <Container as="article" spacing="my-7w">
      <Container as="header" spacing="mb-7w">
        <Title as="h1">Mentions Légales</Title>
      </Container>
      <Container as="main" fluid>
        <Container as="section" spacing="mb-7w">
        ...
        <Container as="section" spacing="mb-7w">
          ...
          <Text>
            ...
            permettant à l’Utilisateur d’identifier les propriétaires de
            logement vacant en France, d’organiser et formaliser une campagne de
            prise de contact des propriétaires de logements vacants et de suivre
          ...
          <Text>
            ...
            régler les relations entre les différents intervenants sur le
            service. Elles définissent les conditions et modalités d’utilisation
            des services.
          </Text>
          <Text>
          ...
          <ul>
            <li>
              d’intégrer ses périmètres géographiques d’intervention
              opérationnels (OPAH, OPAH-RU, OPAH-RR, PIG, etc.).
            </li>
          </ul>
          <Text>
            ...
            qu’une demande d’autorisation aux données LOVAC sur le site du
            CEREMA. Les données de l’Utilisateur sont utilisées conformément aux
          ...
          <Text>
            ...
            des données le concernant, et en particulier son nom et prénom,
            email, téléphone, et son poste dans la collectivité.
          </Text>
          ...
          <ul>
            <li>
              ...
              ou dans des conditions ou selon des modalités qui entraîneraient
              la violation par lui d’autres dispositions ou engagements
              contractuels ou constitutives d’une fraude ;
            </li>
          </ul>
          <ul>
          ...
          <ul>
            <li>
              ...
              portant atteinte aux droits de tiers, et en particulier à des
              droits de propriété intellectuelle (marque, droit d’auteur,
              modèles en particulier), aux droits de personne (notamment
              usurpation d’identité, diffamation, insultes, injures,
              dénigrement, harcèlement, etc.), au respect de la vie privée (en
              ce compris le droit à l’image), à l’ordre public et aux bonnes
              mœurs (notamment apologie des crimes contre l’humanité, incitation
              à la haine raciale, atteinte à la dignité humaine, etc.) et, plus
              généralement, à la réglementation applicable en vigueur et aux
              règles habituelles en matière de pratiques commerciales, de
              politesse et de courtoisie, en particulier dans ses échanges avec
              le support.
            </li>
          </ul>
          ...
          <Text>
            Nous donnons accès sur Zéro Logement Vacant à des données publiques
            à titre informatif. Seules les publications légales font foi,
            notamment au Journal officiel de la République française ou aux
            recueils des actes administratifs des préfectures.
          </Text>
          <Text>
          ...
          <Text>
            ...
            <Link href="mailto:zlv@beta.gouv.fr">zlv@beta.gouv.fr</Link>.
          </Text>
          ...
          <Text>
            ...
            <Link href="mailto:zlv@beta.gouv.fr">zlv@beta.gouv.fr</Link> pour
          ...
          <Text>
            ...
            marques régulièrement déposées auprès de l’Institut national de la
            propriété industrielle (INPI). Toute reproduction totale ou
            partielle de ces marques ou de ces logos effectuées à partir des
            éléments du site sans l’autorisation expresse du propriétaire de ce
            site est prohibée au sens des articles L. 713-2 et suivants du Code
            de la propriété intellectuelle. Tout contrefacteur s’expose aux
            sanctions prévues aux articles L. 716-1 et suivants du code de la
            propriété intellectuelle.
          </Text>

          <Text bold>Code source</Text>
          <Text>
            Le code source de l’application web et de l’interface de
            programmation applicative (API) sont libres et peuvent donc être
            vérifiés et améliorés par chacun dans les conditions précisées par
            la licence MIT (
            <Link href="https://mit-license.org/">
          ...
          <ul>
            <li>
              ...
              <Link href="https://github.com/MTES-MCT/zero-logement-vacant/tree/main/frontend">
          ...
          <ul>
            <li>
              ...
              <Link href="https://github.com/MTES-MCT/zero-logement-vacant/tree/main/server">
          ...
          <Text>
            Zéro Logement Vacant ne saurait être tenu responsable des
            éventuelles difficultés de fonctionnement du service, ni être engagé
            directement ou indirectement vis-à-vis des utilisateurs pour tout
            incident tenant au fonctionnement de service.
          </Text>
          <Text>
          ...
          <Text>
            ...
            l’Éditeur se réserve le droit de mettre fin ou restreindre sans
            aucun avertissement préalable et à sa seule discrétion, votre usage
            et accès aux services, à votre compte et à tous les Sites.
          </Text>
          ...
          <Text>
            ...
            interprétées conformément aux lois de France, et notamment à la Loi
            n° 78-17 du 6 janvier 1978 relative à l&#x27;informatique, aux
            fichiers et aux libertés. Le choix de la loi applicable ne porte pas
            atteinte à vos droits en tant que consommateur conformément à la loi
            applicable de votre lieu de résidence. Si vous êtes un consommateur,
            vous et nous acceptons de se soumettre à la compétence non-exclusive
            des juridictions françaises, ce qui signifie que vous pouvez engager
            une action relative aux présentes CGU en France ou dans le pays de
          ...
          <Text>
            ...
            contestations à la validité, l&#x27;interprétation et / ou
            l’exécution des présentes CGU devront être portées même en cas de
            pluralité des défendeurs ou d’appel en garantie, devant les
            tribunaux français.
          </Text>
        </Container>
        <Container as="section">
          ...
          <Text>
            ...
            traitement des données à caractère personnel de leurs utilisateurs,
            et ce afin de protéger la vie privée de ceux-ci.
          </Text>
          <Title as="h3" spacing="mt-4w">
          ...
          <Text>
            ...
            Utilisateurs qu’à des fins à la fois légitimes et nécessaires, afin
            de remplir la mission de service public dont il est investi. Cela
          ...
          <Text>
            La nature des opérations réalisées sur les données est le stockage
            de ces données.
          </Text>
          ...
          <Text>
            ...
            supprimées. Les données associées à un Utilisateur sont anonymisées
            et conservées à des fins exclusivement statistiques et pourront être
          ...
          <Text>
            ...
            agissant uniquement dans le cadre de la finalité du traitement
            définie dans les présentes CGU.
          </Text>
          ...
          <Text>
            ...
            Les cookies enregistrent des informations relatives à la navigation
            sur le service (les pages que vous avez consultées, la date et
            l&#x27;heure de la consultation...) qui pourront être lues lors de
          ...
          <Text>
            ...
            l’utilisation de ces cookies. La durée de vie des cookies n’est pas
            prolongée à chaque visite. Le consentement de l’Utilisateur devra
          ...
          <Text>
            ...
            soient utilisés sur votre terminal, la plupart des navigateurs vous
          ...
          <Text>
            Les données techniques anonymisées sont conservées sans limitation
            de durée.
          </Text>
          ...
          <Text>
            Par mail : 
            <Link href="mailto:zlv@betagouv.fr">zlv@beta.gouv.fr</Link>
          </Text>
          ...
          <Text>
            ...
            CNIL (3 place de Fontenoy – TSA 80715 – 75334 PARIS CEDEX 07). Les
            modalités de réclamation sont précisées sur le site de la CNIL :
            www.cnil.fr.
          </Text>
          ...
          <Text>
            ...
            faire restituer l&#x27;ensemble des données vous concernant sur
            simple demande. L&#x27;Utilisateur se voit ainsi garantir une
            meilleure maîtrise de ses données, et garde la possibilité de les
            réutiliser. Ces données devront être fournies dans un format ouvert
          ...
          <Text>
            ...
            conservation ou d&#x27;archivage nécessaire à l&#x27;accomplissement
            des finalités déterminées ou imposées est atteinte. Conformément à
            la loi n°78-17 du 6 janvier 1978 relative à l&#x27;informatique, aux
            fichiers et aux libertés, vous disposez par ailleurs de la
            possibilité de demander la suppression de vos données, que vous
            pouvez exercer à tout moment en nous contactant directement à
            l’adresse 
            <Link href="mailto:zlv@betagouv.fr">zlv@beta.gouv.fr</Link>.
          </Text>
          ...
          <Text>
            Nous nous engageons à mettre en œuvre toutes les mesures techniques
          ...
          <ul>
            <li>
              ...
              heures après en avoir pris connaissance, à moins que la violation
              ne présente pas de risque pour vos droits et libertés
            </li>
          </ul>
