                ...
                <Container spacing="t-7w" >
                    <Callout hasInfoIcon={false}>
                        ...
                        <CalloutText as="p">
                            ...
                            <br />      Si le logement n'est pas à usage d'habitation: Logement équipé d'éléments de confort minimum (installation électrique, eau courante, équipement sanitaire), vous n'avez pas à payer la TLV.
                            ...
                            <br /><ul>
                                ...
                                <li>Résidence secondaire meublée soumise à la taxe d'habitation</li></ul>
                        </CalloutText>
                    </Callout>
                </Container>
                    ...
                    <Callout hasInfoIcon={false}>
                        ...
                        <CalloutText as="p">
                            ...
                            <ul>
                                ...
                                <li>Pour en savoir plus, <a href="https://www.service-public.fr/particuliers/vosdroits/F17293"> consultez cette page sur service-public.fr</a> </li></ul>
                        </CalloutText>
                    </Callout>
                </Container>
