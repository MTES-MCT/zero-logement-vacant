...
import { HousingTemplate } from '../templates/Housing.js';

type TemplateName = 'campaign' | 'housing';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <button
            onClick={() => setSelectedTemplate('housing')}
            style={{
              padding: '0.5rem 1rem',
              backgroundColor:
                selectedTemplate === 'housing' ? '#0066cc' : '#fff',
              color: selectedTemplate === 'housing' ? '#fff' : '#333',
              border: '1px solid #ddd',
              borderRadius: '4px',
              cursor: 'pointer',
              fontWeight: selectedTemplate === 'housing' ? 'bold' : 'normal'
            }}
          >
            Housing Template
          </button>
