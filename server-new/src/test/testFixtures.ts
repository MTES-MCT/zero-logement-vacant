...
import { EventKinds } from '@zerologementvacant/shared';
import { EventCategories } from '@zerologementvacant/shared';
import { EventSections } from '@zerologementvacant/shared';
import {
  DatafoncierHousing,
  firstDefined,
  HOUSING_SOURCES,
