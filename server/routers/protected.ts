...
router.get(
  '/housing/campaigns/bundles/number/:campaignNumber?/:reminderNumber?/export',
  housingController.exportHousingByCampaignBundle
);
router.get(
  '/housing/normalizeAddresses/:establishmentId',
...
router.post(
  '/monitoring/establishments/data',
  monitoringController.listEstablishmentData
);
router.post(
  '/monitoring/housing/status/count',
  monitoringController.housingByStatusCount
);
router.post(
  '/monitoring/housing/status/duration',
