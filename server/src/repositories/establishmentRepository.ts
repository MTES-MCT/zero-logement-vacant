...
export function formatEstablishmentApi(
  ...
  return {
    ...
    campaign_intent: establishment.campaignIntent,
...
export function parseEstablishmentApi(
  ...
  return {
    ...
    priority: establishment.priority ?? 'standard',
    kind: establishment.kind,
    source: establishment.source
  };
}
