 ...
 * /campaigns/{id}/groups:
 *   post:
 *     summary: Créer une campagne à partir d'un groupe
 *     description: Crée une nouvelle campagne basée sur les logements d'un groupe existant
 *     tags: [Campaigns, Groups]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *           type: string
 *           format: uuid
 *         description: ID du groupe source
 *     responses:
 *       201:
 *         description: Campagne créée
 *         content:
 ...
 * /campaigns/{id}/export:
 *   get:
 *     summary: Exporter les logements d'une campagne
 *     description: |
 *       Génère un fichier CSV avec les logements et propriétaires de la campagne.
 *
 *       **Colonnes du CSV:**
 *       - Identifiant local, Invariant, Adresse, Code postal, Commune
 *       - Statut de suivi, Sous-statut, Occupation
