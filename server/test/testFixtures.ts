...
export const genDatafoncierOwner = (
  ...
  ddenom: randomstring.generate(60),
  gtyp3: randomstring.generate(1),
  gtyp4: randomstring.generate(1),
  gtyp5: randomstring.generate(1),
  gtyp6: randomstring.generate(1),
  dlign3: randomstring.generate(30),
  dlign4: randomstring.generate(36),
  dlign5: randomstring.generate(30),
  dlign6: randomstring.generate(32),
